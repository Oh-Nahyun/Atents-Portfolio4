...
public class Player : MonoBehaviour
{
    ...
    /// <summary>
    /// 플레이어가 죽었음을 알리는 델리게이트 (float : 전체 플레이 시간, int : 킬카운트)
    /// </summary>
    ...
    /// 몬스터를 잡았을 때 실행할 함수
    /// </summary>
    /// <param name="bonus">몬스터 처리 보너스 (수명 추가)</param>
